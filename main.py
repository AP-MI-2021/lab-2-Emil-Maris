...
def meniu():
    print("Daca vreti sa gasiti ultimul nr prim mai mic decat o valoare data, tastati 1.")
    print("Daca vreti sa transformati un numar din baza 10 in baza 2, tastati 2.")
    print("Daca vreti sa verificati daca un numar este antipalindrom, tastati 3.")
    print("Daca vreti sa inchideti programul, tastati 4.")
...
def main():
    while True:
        meniu()
        optiune = input("Alege-ti optiunea: ")
        if optiune == '1':
            nr = int(input("Scrieti numarul: "))
            print("Cel mai mare numar prim, mai mic decat " + str(nr) + ", este: " + str(get_largest_prime_below(nr)))
        elif optiune == '2':
            nr = int(input("Scrieti numarul pe care doriti sa-l convertiti din baza 10 in baza 2: "))
            print("Numarul " + str(nr) + "convertit din baza 10 in baza 2 este: " + get_base_2(nr))
        elif optiune == '3':
            nr = int(input("Scrieti numarul care se va determina daca este antipalindrom: "))
            if not is_antipalindrome(nr):
